...
Route::group(['middleware' => ['cors']], function() {
    ...
    Route::get('port/buyer/status/{buyer_id}/{status}', 'PortController@changePortStatusBuyer');
    Route::get('port/seller/status/{seller_id}/{status}', 'PortController@changePortStatusSeller');
