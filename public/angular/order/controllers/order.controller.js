...
angular.module('order').controller('BuyOrderController', ['$location', '$scope', '$http', '$uibModal', '$filter', '$stateParams', '$state', 'Order', 'Buyer', 'Product', '$rootScope',
  function($location, $scope, $http, $uibModal, $filter, $stateParams, $state, Order, Buyer, Product, $rootScope) {
