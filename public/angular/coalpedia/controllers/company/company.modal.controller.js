...
angular.module('coalpedia').controller('CompanyModalController', ['$scope', '$uibModalInstance', '$timeout', '$interval', 'Company', 'Term', 'company', 'companyType', 'Area', 'Country',
  function($scope, $uibModalInstance, $timeout, $interval, Company, Term, company, companyType, Area, Country) {
